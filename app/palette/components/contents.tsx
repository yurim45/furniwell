        ...
        {activeTab === 'palette' && (
          <>
            ...
            <DetailContent>
              ...
              이를 통해 고객사에게는 비용 효율적이면서도 내구성이 뛰어난 목재 팔렛트를 제공합니다. <br />
              <br />
        ...
        {activeTab === 'paper_box' && (
          <>
            ...
            <DetailContent>
              ...
              ■ 국제 규격 준수 (ISPM 15) <br />
              우리가 제작하는 모든 수출용 목상자는 국제식물보호협약(ISPM 15) 기준을 준수합니다. <br /> <br />
              열처리(HT) 방역 처리를 통해 목재에 숨어있는 병해충을 완벽하게 제거하며, 공식 소독처리 마크를 부착하여 전
              세계 어느 국가로든 안심하고 수출할 수 있도록 합니다.
