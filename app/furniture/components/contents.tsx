        ...
        {activeTab === 'indoor' && (
          <>
            ...
            <DetailContent>
              ...
              <br />
              <br />
              저희 공장의 강점은 높은 품질을 유지하면서도 합리적인 가격을 제공하는 것입니다. <br />
              <br />
              효율적인 생산 시스템과 엄격한 품질 관리를 통해 뛰어난 내구성과 심미성을 갖춘 가구를 제작하며, <br />
              다양한 소재와 디자인을 다루는 저희의 창의성과 기술력은 어떤 스타일의 가구라도 완벽하게 구현해 낼 수 있는
              기반이 됩니다. <br />
        ...
        {activeTab === 'outdoor' && (
          <>
            ...
            <DetailContent>
              ...
              <br /> <br />
              야외 공간을 위한 가구나 조형물 제작을 고려하고 계신다면, 저희와 함께하세요.풍부한 경험과 뛰어난 기술력으로
